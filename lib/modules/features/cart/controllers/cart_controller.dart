...
import '../view/components/delete_cart_item_dialog.dart';
import '../view/components/discount_info.dart';
...
class CartController extends GetxController {
  ...
  Future<void> getVouchers() async {
    ...
    listVoucherRes.fold((l) {
      voucherStatus.value = 'error';
      if (l.statusCode != 204) return;
  ...
  Future<void> order() async {
    ...
    final cartReq = CartReq(
      user: LocalDBServices.getUser() as User,
      cart: cart,
  ...
  Future<void> openPinDialog() async {
    ...
    /// Ambil data user
    final User user = LocalDBServices.getUser() as User;
