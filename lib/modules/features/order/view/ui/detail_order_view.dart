...
import '../../../../../shared/widgets/empty_data_list_view.dart';
...
import '../components/checked_step.dart';
import '../components/detail_order_card.dart';
import '../components/unchecked_step.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                ...Conditional.list(
                  context: context,
                  conditionBuilder: (context) =>
                      DetailOrderController.to.order.value!.idVoucher != 0,
                  widgetBuilder: (context) => [
                    TileOption(
                ...
                TileOption(
                  ...
                  message: DetailOrderController.to.order.value!.totalBayar
                      .toRupiah(),
                  titleStyle: Get.textTheme.headlineSmall,
